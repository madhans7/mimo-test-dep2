                ...
                <>
                  <div className="flex items-center justify-center gap-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-xs text-slate-400">PDF, DOCX, PPTX, Images & more</p>
                    </div>
                  </div>
                  <input ref={fileInputRef} type="file" multiple className="hidden" accept=".pdf,.doc,.docx,.pptx,.ppt,.xlsx,.xls,.txt,.jpg,.jpeg,.png" onChange={(e) => handleFileSelect(e.target.files)} />
                </>
              ) : (
                <>
                  {/* Pulsing ring + icon */}
