...
export function MimoHeader() {
  ...
  return (
    <>
      <div className="flex items-center justify-between border-b-[5px] border-[#194059] mb-2 sm:mb-8 pt-4 pb-2 sm:pb-3">
        <div className="flex items-center gap-2 cursor-pointer group" onClick={() => navigate("/upload")}>
          <h1 
            className="text-4xl sm:text-5xl font-black text-[#194059] select-none m-0"
            style={{ fontFamily: "'Lovelo', sans-serif", lineHeight: "1" }}
          >
            MIMO
          </h1>
        </div>
