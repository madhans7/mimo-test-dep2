...
async function runTest() {
  try {
    console.log("🚀 Starting E2E Direct Print Test for SV-002 Monochrome (Brother Printer)...");
    ...
    await jobRef.set({
      userId,
      status: "pending",
      fileName: "DirectPrintTest_SV002_BW.pdf",
      fileUrl: "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf",
      pageCount: 1,
      colorMode: "monochrome", // SV-002 will route this to Brother B&W
