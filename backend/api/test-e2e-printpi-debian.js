...
async function runTest() {
  try {
    console.log("🚀 Starting E2E Direct Print Test for CV-001 with Image Scaling (Fill) Pikachu...");
    ...
    await jobRef.set({
      userId,
      status: "pending",
      fileName: "DirectPrintTest_CV001_DEBIAN.png",
      fileUrl: "https://www.debian.org/logos/openlogo-nd-100.png",
      pageCount: 1,
    ...
    if (directKioskId) {
      ...
      console.log(`✅ Backend successfully routed to Direct Print Kiosk: CV-001`);
    } else {
